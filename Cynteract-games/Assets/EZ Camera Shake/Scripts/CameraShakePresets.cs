...
namespace EZCameraShake
{
    ...
    public static class CameraShakePresets
    {
        ...
        public static CameraShakeInstance DirectedBump(Vector3 direction)
        {
            
            
                CameraShakeInstance c = new CameraShakeInstance(2.5f, 4, 0.1f, .1f);
                c.PositionInfluence =0.5f* direction;
        ...
        /// <summary>
        /// [One-Shot] An not so intense and rough shake.
        /// </summary
        public static CameraShakeInstance SmallExplosion
        {
            get
            {
                CameraShakeInstance c = new CameraShakeInstance(1f, 10, 0, 1f);
                c.PositionInfluence = Vector3.one * 0.15f;
                c.RotationInfluence = new Vector3(2, .5f, .5f);
                return c;
            }
        }
        /// <summary>
        ...
        /// </summary>
        public static CameraShakeInstance Falloff
        {
            get
            {
                CameraShakeInstance c = new CameraShakeInstance(0.2f, 10f, 0f, 2f);
                c.PositionInfluence = new Vector3(0, 0.15f, 0);
                c.RotationInfluence = new Vector3(1.25f, 0, 2);
                return c;
            }
        }
        ...
        /// [Sustained] A very rough, yet low magnitude shake.
        /// </summary>
        public static CameraShakeInstance LowVibration
        {
            get
            {
                CameraShakeInstance c = new CameraShakeInstance(0.1f, 5f, 0.1f, 0.1f);
                c.PositionInfluence = new Vector3(0, 0.15f, 0);
                c.RotationInfluence = new Vector3(1.25f, 0, 2);
                return c;
            }
