...
namespace ChartUtil.Demo
{
    public class ChartDemoBasicScripting : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            series1.name = "Sold";
            series1.data.Add(new Data(122.5f, true));
            series1.data.Add(new Data(95.8f, true));
            series1.data.Add(new Data(53.6f, true));
            series1.data.Add(new Data(36.4f, true));
            series1.data.Add(new Data(45.9f, true));
            series1.data.Add(new Data(87.4f, true));

            Series series2 = new Series();
            series2.name = "Storage";
            series2.data.Add(new Data(152.8f, true));
            series2.data.Add(new Data(36.5f, true));
            series2.data.Add(new Data(98.3f, true));
            series2.data.Add(new Data(125.7f, true));
            series2.data.Add(new Data(36.2f, true));
            series2.data.Add(new Data(78.9f, true));
